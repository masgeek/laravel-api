...
class EditHotel extends Component {
    ...
    handleUpdateHotel(event) {
        ...
        axios.put(`/api/hotels/${id}`, project)
            .then(response => {
            ...
            <div className='container py-4'>
                <div className='row justify-content-center'>
                    <div className='col-md-12'>
                        <div className='card'>
                            <div className='card-header'>Update hotel: {this.state.name}</div>
                            <div className='card-body'>
                                <form onSubmit={this.handleUpdateHotel}>
                                    ...
                                    <button className='btn btn-outline-dark btn-block'>Update hotel</button>
                                </form>
                            </div>
                        </div>
                    </div>
